...
export const messages = {
  ja: {
    ...
    products: {
      ...
      overview: {
        title: '製品概要',
        description: 'ZIFU技研は、ZINGDECKがグローバルに展開するAIプロダクト群の中から、\n日本市場との親和性が高い3製品を中核に提供しています。\n\n学習・ビジネス・コンテンツ制作のあらゆるシーンで、\nAIの力をシンプルに、実用的に。',
        icons: [
    ...
    team: {
        ...
        items: [
          {
            ...
            title: '代表取締役',
            bio: [
              '百度（Baidu）、人人網（RenRen）、ポップマート（POP MART）など、中国を代表するIT企業において20年以上にわたり人事・経営管理・事業運営責任者を歴任。',
              '急成長IT企業における組織構築、人材戦略、事業運営の豊富な経験を活かし、日本法人の立ち上げを主導。現在は、日本市場における事業戦略の策定、販売展開、パートナー企業との連携を統括しています。'
            ]
          },
          {
            name: '福田 高幹',
            ...
            bio: [
              ...
              '現在は、日本市場における事業運営、パートナー企業との連携、対外コミュニケーションを担当し、日本法人の円滑な事業展開を支えています。'
            ]
          },
          {
            name: '曹 鴻源',
            ...
            bio: [
              ...
              '現在は、AIプロダクトの戦略立案、開発を統括するとともに、日本市場を含むグローバル展開を推進しています。'
            ]
          }
        ]
      },
      philosophy: {
        title: '人材理念',
        content: [
          'ZIFU技研は、「グローバルなテクノロジー × 地域に根ざした現場力」を企業としての価値観に掲げています。\n\n',
          '私たちが大切にする価値観：\n\n',
