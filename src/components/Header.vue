    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center space-x-8">
          <button @click="go('/')" class="flex items-center space-x-2 cursor-pointer"><img :src="logoImg" alt="ZingStone" class="w-10 h-10 rounded-full object-cover"><span class="font-bold text-xl text-gray-800">ZingStone</span></button>
        ...
        <div class="hidden md:flex items-center"><div class="relative" @mouseenter="isLanguageOpen = true" @mouseleave="isLanguageOpen = false">
          ...
          <div v-if="isLanguageOpen" class="absolute right-0 top-full pt-2">
            <div class="w-28 rounded-lg shadow-xl py-1 border border-gray-200 bg-white/95 backdrop-blur-md overflow-hidden">
