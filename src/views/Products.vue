...
import videoCompressImage from '@/assets/images/videocompress-website.png'
import videoBeeImage from '@/assets/images/videobee-website.png'
import audioCutImage from '@/assets/images/audiocut-website.png'
