...
import { FileCheck, FileText } from 'lucide-vue-next'
...
const termsData = computed(() => messages[effectiveLocale.value]?.terms)
      ...
      <section class="py-12 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center space-x-4 mb-8">
            ...
            <div>
              <h1 class="text-3xl font-bold text-gray-900">{{ termsData.title }}</h1>
              <p class="text-gray-600">{{ termsData.lastUpdated }}</p>
            </div>
          </div>

          <div class="prose prose-lg max-w-none">
            <div v-for="(section, index) in termsData.sections" :key="index">
