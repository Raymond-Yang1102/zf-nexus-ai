<template>
  <div class="min-h-screen bg-white">
    ...
    <main class="pt-16">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div v-for="(member, index) in teamData.members.items" :key="index"
              ...
              <div class="flex items-start space-x-6">
                <div
                  class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center flex-shrink-0">
      ...
      <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 class="text-2xl font-bold text-gray-800 mb-8 text-center">{{ teamData.philosophy.title }}</h2>
          <div class="prose prose-lg text-gray-600 leading-relaxed text-center">
          ...
          <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
            <div v-for="(value, index) in teamValues" :key="index"
              ...
              <div
                class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center mx-auto mb-4">
